...
sealed class GetWeatherForecastListResult : ResultState {
    ...
    data class GetForecastWeatherFailure(
        val failure: FailureWithCache<MutableList<WeatherForecastUIModelListItem>>
    ) : GetWeatherForecastListResult()
}